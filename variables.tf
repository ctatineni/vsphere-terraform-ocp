...
variable "binaries" {
  ...
  default = {
    ...
    openshift_client    = "https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/4.4.10/openshift-client-linux.tar.gz"
    openshift_installer = "https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/4.4.10/openshift-install-linux.tar.gz"
